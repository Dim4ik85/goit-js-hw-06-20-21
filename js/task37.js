...
строчному значению какого-то свойства. Например, есть группа студентов с 
баллами за тест. Необходимо отсортировать массив объектов по возрастанию и
...
//   const sortedByDescentingRating = books;
  ...
  const sortedByAuthorName = [...books].sort((firstNameAuthor,seconNamedAuthor) =>
        firstNameAuthor.author.localeCompare(seconNamedAuthor.author));
console.log(sortedByAuthorName);
  const sortedByReversedAuthorName = [...books].sort((firstNameAuthor,seconNamedAuthor) =>
        seconNamedAuthor.author.localeCompare(firstNameAuthor.author));
